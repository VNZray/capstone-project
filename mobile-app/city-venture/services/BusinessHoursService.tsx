...
// Fetch all business hours (from business backend on port 4000)
export const fetchAllBusinessHours = async (): Promise<BusinessSchedule> => {
  try {
    const { data } =
      await businessApiClient.get<BusinessHours[]>(`/business-hours`);
...
export const fetchBusinessHoursByBusinessId = async (
  ...
  try {
    ...
    console.error(
      "[BusinessHoursService] fetchBusinessHoursByBusinessId error:",
      error,
    );
    return [];
  }
