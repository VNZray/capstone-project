...
export const createTouristSpot = async (req, res) => {
  try {
    ...
    // Validate required fields (keep this as is)
    if (
      !name ||
      !description ||
      !province_id ||
      ...
      return res.status(400).json({
        success: false,
        message:
          "Name, description, province_id, municipality_id, barangay_id, latitude, longitude, contact_phone, contact_email, category_id, and type_id are required",
      });
    }
