...
import { Input, FormControl, FormLabel, FormHelperText, Divider, AspectRatio, Card } from "@mui/joy";
import { useState, useEffect } from "react";
import { Image, Palette, Layout, Camera, Save, RotateCcw } from "lucide-react";
...
const Settings = () => {
  ...
  const [settings, setSettings] = useState({
    landingPageImage: "https://www2.naga.gov.ph/wp-content/uploads/2021/10/Aerial-View-Naga-City-ScubaFlyer-PH.jpg",
    loginPageImage: "https://www2.naga.gov.ph/wp-content/uploads/2021/10/Aerial-View-Naga-City-ScubaFlyer-PH.jpg",
    primaryColor: "#0A1B47",
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>, type: "landing" | "login") => {
    const file = e.target.files?.[0];
    if (!file) return;

    const validTypes = ["image/jpeg", "image/jpg", "image/png", "image/webp"];
    if (!validTypes.includes(file.type)) {
      setErrors({ ...errors, [type]: "Please upload a valid image (JPEG, PNG, or WebP)" });
      return;
    }
    ...
    const setUploading = type === "landing" ? setUploadingLanding : setUploadingLogin;
    setUploading(true);
    ...
    try {
      ...
      setSettings({
        ...settings,
        [type === "landing" ? "landingPageImage" : "loginPageImage"]: publicData.publicUrl,
      });
    } catch (error: any) {
      console.error("Image upload error:", error);
      setErrors({ ...errors, [type]: "Failed to upload image. Please try again." });
    } finally {
      setUploading(false);
    }
  };
    ...
    <PageContainer>
      <Container gap="24px" padding="0">
        ...
        <Container elevation={2} direction="row" justify="space-between" align="center">
          <div>
            <Typography.Header>Application Settings</Typography.Header>
            <Typography.Body sx={{ color: "neutral.500", mt: 1 }}>
              Configure landing page, login page, theme colors, and app behavior
            </Typography.Body>
          </div>
        ...
        <Container elevation={2}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <Layout size={24} />
            <Typography.CardTitle>Landing Page Settings</Typography.CardTitle>
          </div>
          <Divider sx={{ my: 2 }} />
              ...
              <div style={{ display: "flex", gap: "16px", flexWrap: "wrap", alignItems: "flex-start" }}>
                <Card variant="outlined" sx={{ width: 300 }}>
                  <AspectRatio ratio="16/9">
                    <img src={settings.landingPageImage} alt="Landing page preview" style={{ objectFit: "cover" }} />
                  </AspectRatio>
                </Card>
                <div>
                  <input
                  ...
                  <FormHelperText>Recommended size: 1920x1080px. Max 10MB</FormHelperText>
                </div>
              </div>
            </FormControl>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
            <FormControl>
              ...
              <div style={{ display: "flex", gap: "16px", flexWrap: "wrap", alignItems: "flex-start" }}>
                <Card variant="outlined" sx={{ width: 300 }}>
                  <AspectRatio ratio="16/9">
                    <img src={settings.loginPageImage} alt="Login page preview" style={{ objectFit: "cover" }} />
                  </AspectRatio>
                </Card>
                <div>
                  <input
        ...
        <Container elevation={2}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <Palette size={24} />
            <Typography.CardTitle>Theme Color Settings</Typography.CardTitle>
          </div>
          <Divider sx={{ my: 2 }} />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "20px" }}>
            <FormControl>
              ...
              <FormHelperText>Main brand color used throughout the app</FormHelperText>
            </FormControl>
        ...
        {/* App Configuration */}
        <Container elevation={2}>
          <Typography.CardTitle>Application Configuration</Typography.CardTitle>
          <Divider sx={{ my: 2 }} />
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            <FormControl>
              ...
              />
              <FormHelperText>Display name for the application</FormHelperText>
            </FormControl>
            ...
            <FormControl>
              ...
              />
              <FormHelperText>Tagline or subtitle for the application</FormHelperText>
            </FormControl>
          </div>
        </Container>
