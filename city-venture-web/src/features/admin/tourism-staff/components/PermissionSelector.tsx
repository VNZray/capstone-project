...
const categoryIcons: Record<string, React.ReactNode> = {
  ...
  // Tourism Portal Categories
  "Tourism Staff Management": <Users size={18} />,
  "Tourist Spot Management": <MapPin size={18} />,
  "Event Management": <Calendar size={18} />,
  "Business Approval": <CheckCircle size={18} />,
  "Content Management": <FileText size={18} />,
  "User Management": <UserCog size={18} />,
  "Tourism Reporting": <BarChart size={18} />,
  "Tourism Settings": <Settings size={18} />,
  "Emergency Facilities": <AlertCircle size={18} />,

  // System Administration
  "System Administration": <Shield size={18} />,
};
...
const categoryColors: Record<string, string> = {
  ...
  // Tourism Portal
  "Tourism Staff Management": "neutral",
  "Tourist Spot Management": "success",
  "Event Management": "warning",
  "Business Approval": "success",
  "Content Management": "primary",
  "User Management": "info",
  "Tourism Reporting": "primary",
  "Tourism Settings": "neutral",
  "Emergency Facilities": "danger",

  // System
  "System Administration": "neutral",
};
...
export default function PermissionSelector({
  ...
  const filteredCategories = React.useMemo(() => {
    ...
    // Hide User Management and Tourism Staff Management for non-Admin roles
    return categories.filter(
      (cat) =>
        cat.category_name !== "User Management" &&
        cat.category_name !== "Tourism Staff Management"
    );
  }, [categories, isAdminRole]);

  const totalPermissions = filteredCategories.reduce(
