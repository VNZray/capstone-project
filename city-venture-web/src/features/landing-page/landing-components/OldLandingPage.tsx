...
export default function LandingPage() {
  ...
  const [activeTab, setActiveTab] = React.useState<"tourists" | "businesses">(
    "tourists"
  );
      ...
      >
                ...
                <Button
                  ...
                  sx={{
                    ...
                    "&:focusVisible": {
                      outline: "none",
                      boxShadow:
                        "0 0 0 3px rgba(255,145,77,0.35), 0 10px 26px rgba(0,0,0,0.12)",
                    },
                  }}
                >
                  Get Started
        ...
        >
          <div className="value-prop-inner">
            <h2 className="vp-title-gradient">
            ...
            <div className="vp-grid">
              ...
              <div className="vp-card vp-businesses">
                ...
                <p className="vp-card-text">
                  List your hotel, shop, or service and get discovered by
                  tourists searching and exploring Naga City.
                </p>
        ...
        >
          <div className="about-inner">
            ...
            >
              ...
              travelers with curated experiences, and help businesses get
              discovered through clean listings, search, and maps.
            </Typography>
              ...
              <li>
                ...
                <div>
                  ...
                  <div className="feat-text">
                    Discover places, events, and experiences around the city.
                  </div>
                </div>
              </li>
              <li>
          ...
          <Container padding="0" gap="20px" style={{ flex: 1 }}>
            ...
            >
              ...
              >
                ...
                >
                  <img
                    src={mobilePreview || placeholderImage}
        ...
        >
          ...
          >
            ...
            <Typography
              ...
              color="neutral"
              textAlign="center"
              style={{ maxWidth: 600, marginBottom: 32, opacity: 0.9 }}
            >
              Choose your path and follow three easy steps to get the most out
              of City Venture.
            </Typography>
            ...
            >
              <button
                ...
                style={{
                  ...
                  border: "none",
                  background:
                    activeTab === "tourists" ? "#ffffff" : "transparent",
              ...
              <button
                ...
                style={{
                  ...
                  border: "none",
                  background:
                    activeTab === "businesses" ? "#ffffff" : "transparent",
          ...
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            ...
            >
              ...
              >
                ...
                >
                  <li style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    ...
                    >
                      hello@cityventure.io
                    </a>
                  </li>
                  <li style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    <FaPhone />
                    <a href="tel:+1234567890" style={footerLinkStyle}>
                      +1 (234) 567-890
                    </a>
                  </li>
                  <li style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <div>
                ...
                >
                  <li>
                    <a href="/business/signup" style={footerLinkStyle}>
                      Business Registration
                    </a>
                  </li>
                  <li>
                    <a href="/login" style={footerLinkStyle}>
                      Tourist/Admin Login
                    </a>
                  </li>
                  <li>
                    <a href="/business/login" style={footerLinkStyle}>
