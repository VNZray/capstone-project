/**
 * Payment CRUD Controller
 * Handles basic payment CRUD operations (insert, update, delete)
 * These are mainly for internal/admin use
 */
...
export async function deletePayment(req, res) {
  const { id } = req.params;
  try {
    await db.query("CALL DeletePayment(?)", [id]);
