/**
 * RBAC Simplification Migration (DEPRECATED)
 *
 ...
 * - staff.title column: in 20251021043733_staff_table.cjs
 *
...
exports.up = async function (knex) {
  console.log("[RBAC Simplification] Migration (no-op - consolidated into user_table migration)");
};

exports.down = async function (knex) {
  console.log("[RBAC Simplification] Rollback (no-op)");
};
