 ...
 */
async function getAllCategories(applicableTo = null, status = null, parentId = null) {
 ...
 */
async function getCategoryTree(applicableTo = null) {
 ...
 */
async function getEntityCategories(entityId, entityType) {
 ...
 */
async function addEntityCategory(entityId, entityType, categoryId, level = 1, isPrimary = false) {
  const [rows] = await db.query(
 ...
 * @param {number} categoryId - Category ID
 */
async function removeEntityCategory(entityId, entityType, categoryId) {
  const [rows] = await db.query(
 ...
 */
async function setEntityPrimaryCategory(entityId, entityType, categoryId) {
  const [rows] = await db.query(
 ...
 */
async function getEntitiesByCategory(categoryId, entityType = null, includeChildren = false) {
  const [rows] = await db.query(
