...
await knex("user_role").insert([
  ...
  { id: 3, role_name: "Event Coordinator", description: "Manages event listings, participant data, and schedules." },

  // Business Side
  { id: 4, role_name: "Owner", description: "Owner of a business listing; manages all operations and assigns staff roles." },
