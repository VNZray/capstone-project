...
router.get("/business/:businessId", authenticate, authorizeRole("Owner", "Staff", "Admin"), orderController.getOrdersByBusinessId);
router.get("/business/:businessId/stats", authenticate, authorizeRole("Owner", "Staff", "Admin"), orderController.getOrderStatsByBusiness);
router.post("/business/:businessId/verify-arrival", authenticate, authorizeRole("Owner", "Staff", "Admin"), orderController.verifyArrivalCode);
...
router.patch("/:id/status", authenticate, authorizeRole("Owner", "Staff", "Admin"), orderController.updateOrderStatus);
...
router.post("/:id/arrived", authenticate, authorizeRole("Owner", "Staff", "Admin"), orderController.markCustomerArrivedForOrder);
router.post("/:id/mark-ready", authenticate, authorizeRole("Owner", "Staff", "Admin"), orderController.markOrderAsReady);
router.post("/:id/mark-picked-up", authenticate, authorizeRole("Owner", "Staff", "Admin"), orderController.markOrderAsPickedUp);
