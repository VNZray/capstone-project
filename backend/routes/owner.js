...
router.get("/", authenticate, authorizeRole('Admin', 'Tourism Officer'), authorize('view_all_profiles'), ownerController.getAllOwners);
...
router.delete("/:id", authenticate, authorizeRole('Admin', 'Tourism Officer'), authorize('manage_users'), ownerController.deleteOwnerById);
