 ...
 * Permissions Seeder
 *
 * Seeds the permission table with all application-wide permission matching old backend.
 * Table schema: id (auto), name, description
 */
module.exports = {
  async up(queryInterface) {
    ...
    await queryInterface.bulkInsert('permissions', [
      ...
      // Subscriptions
      { name: 'manage_subscriptions', description: 'Manage business subscriptions' },
      ...
      // Settings
      { name: 'view_settings', description: 'View application settings' },
      { name: 'edit_settings', description: 'Edit application settings' },
