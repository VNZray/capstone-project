...
/**
 * Municipalities Seeder
 *
 * Seeds municipalities for Camarines Sur (province_id: 20) matching the old backend structure.
 */
module.exports = {
  async up(queryInterface) {
    await queryInterface.bulkInsert('municipality', [
    ...
    console.log('[Seed] Municipalities seeded.');
  },

  async down(queryInterface) {
    await queryInterface.bulkDelete('municipality', null, {});
  }
};
